...
*************************************************************************/
// MaintainDepth.h: interface for the CMaintainDepth class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(MAINTAIN_DEPTH)
#define MAINTAIN_DEPTH
...
class CMaintainDepth : public CSGMOOSBehaviour  
{
public:
    CMaintainDepth();
    virtual      ~CMaintainDepth();
...
protected:
    ...
    bool m_bIsLimitingBehavior;
    ControlledDOF m_DepthDOF;

};

#endif // !defined(MAINTAIN_DEPTH)
