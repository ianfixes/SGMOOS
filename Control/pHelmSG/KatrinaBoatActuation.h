...
*************************************************************************/
//
// C++ Interface: KatrinaBoatMapping
//
// Description: 
//
//
...
//
//
#ifndef KATRINABOATMAPPING_H
#define KATRINABOATMAPPING_H
...
class CKatrinaBoatActuation : public CMOOSActuationMap
{
public:
    CKatrinaBoatActuation();
