...
bool CKatrinaBoatActuation::Engage(const CPathAction& DesiredAction, MOOSVARMAP& VarMap)
{
    ...
    dfNow = MOOSTime();
    VarMap["STARBOARD_MOTOR"].Set(dfStarboard, dfNow);
    VarMap["PORT_MOTOR"].Set(dfPort, dfNow);
