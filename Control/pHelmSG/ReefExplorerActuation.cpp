...
bool CReefExplorerActuation::Engage(const CPathAction& DesiredAction, MOOSVARMAP& VarMap)
{
    ...
    VarMap["WINCH"].Set(dfDesiredWinch, dfNow);
    ...
    VarMap["STARBOARD_THRUST"].Set(dfStarboardThrust, dfNow);
    VarMap["PORT_THRUST"].Set(dfPortThrust, dfNow);
    ...
    VarMap["BOW_XBODY"].Set(dfBowCBT,dfNow);
    VarMap["STERN_XBODY"].Set(dfSternCBT,dfNow);
